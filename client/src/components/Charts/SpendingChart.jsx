...
const SpendingChart = () => {
    ...
    const fetchData = useCallback(async () => {
        setLoading(true);
        try {
            const res = await api.get('/dashboard/spending', {
                params: { year, period }
            });
        ...
        const option = {
            ...
            tooltip: {
                ...
                formatter: (params) => {
                    ...
                    params.forEach(p => {
                        html += `
                        <div style="display:flex;justify-content:space-between;align-items:center;gap:24px;margin-bottom:2px;">
