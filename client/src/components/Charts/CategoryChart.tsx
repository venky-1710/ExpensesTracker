...
const COLORS = ['#6d4aff','#10b981','#f59e0b','#ef4444','#3b82f6','#ec4899','#14b8a6','#f97316','#8b5cf6','#06b6d4'];
...
const CategoryChart = ({ data }: Props) => {
  ...
  useEffect(() => {
    ...
    const option = {
      ...
      legend: {
        type: 'scroll', orient: 'horizontal', left: 'center', bottom: 0,
        icon: 'circle', itemWidth: 10, itemHeight: 10, itemGap: 14,
        textStyle: { color: '#94a3b8', fontSize: 12, fontFamily: 'Inter, sans-serif' },
        pageIconColor: '#6d4aff', pageIconInactiveColor: '#cbd5e1',
        pageTextStyle: { color: '#94a3b8', fontSize: 11 }, pageButtonItemGap: 6
      },
      series: [{
        name: 'Category', type: 'pie', radius: '50%', center: ['50%', '45%'],
        data: seriesData,
        emphasis: { itemStyle: { shadowBlur: 10, shadowOffsetX: 0, shadowColor: 'rgba(0,0,0,0.5)' } },
        label: { color: '#94a3b8', fontSize: 12, fontFamily: 'Inter, sans-serif' },
